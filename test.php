            ...
            <form action="" class="form" method="POST">
              ...
              <div class="column">
                <div class="input-box">
                  ...
                  <input type="text" name="tempat" placeholder="Enter birth date" required />
                </div>
                <div class="input-box">
              ...
              <div class="input-box">
                <label>Foto</label>
                <input type="file" name="foto" id="foto" accept=".jpg, .jpeg, .png" value="" required />
              </div> 
        ...
        if(isset($_POST['button'])){
          ...
          if(in_array($imgext,$ext)){
            echo "<script>alert('Salah Extensi Gambar');</script>";
            ...
            if (mysqli_query($conn, $query)){
              ...
              $data = mysqli_query($conn,"INSERT INTO tbl_user(id_user, id_account,nama,telepon,tempatlahir,tgl_lahir,jk,alamat,foto) VALUES ('','$id','$nama','$telepon','$tempat','$tgl','$jk','$alamat','$newimg')");
              echo "<script>
                Swal.fire({
                  title: 'Add Data',
